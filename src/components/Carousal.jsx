...
// const Carousal = ({ name, description, coverImage, isActive, isNext }) => {
...
//     >
//       <div
//         className="relative overflow-hidden shadow-lg transform hover:scale-105 w-1/2 object-cover h-72"
...
//           <h2 className="text-white text-5xl p-4 font-bold">{name}</h2>
//           <p className="text-white text-base px-4 md:w-4/5">{description}</p>
